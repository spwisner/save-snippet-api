...
const resources = function (controller, options) {
  ...
  const actions = [
    { path: `/api/${controller}`,     method: 'get',    name: 'index', },
    { path: `/api/${controller}/:id`, method: 'get',    name: 'show', },
    { path: `/api/${controller}`,     method: 'post',   name: 'create', },
    { path: `/api/${controller}/:id`, method: 'patch',  name: 'update', },
    { path: `/api/${controller}/:id`, method: 'put',    name: 'update', },
    { path: `/api/${controller}/:id`, method: 'delete', name: 'destroy', },
  ];
